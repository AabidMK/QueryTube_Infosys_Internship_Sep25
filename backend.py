...
# --- Configuration ---
FILE_NAME = "videos_with_embeddings_cleaned_unique.csv"  # Cleaned CSV with unique IDs
CHROMA_PATH = "chromadb_data"
COLLECTION_NAME = "video_embeddings_all"  # All 557+ videos
            ...
            for idx, row in df.iterrows():
                ...
                if len(full_text) > 10:
                    try:
                        ...
                        print(f"Skipping invalid embedding for {video_id}: {e}")
                        continue
