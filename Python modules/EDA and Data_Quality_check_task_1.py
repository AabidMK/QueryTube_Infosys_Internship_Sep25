...
FILE_PATH = r"./data/processed/Master_task1_Cleaned_main.csv" 
REPORT_FILENAME = "data_quality_and_eda_report_Masterdataset_1.txt"

# New: Define the output directory where all results (plots and report) will be saved
OUTPUT_DIR = r"./EDA_and_DataQuality_Results"
